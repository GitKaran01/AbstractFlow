...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <nav class="bg-indigo-700 text-white p-4 flex justify-between items-center shadow">
        ...
        <form action="/web-logout" method="POST"><?php echo csrf_field(); ?> <button class="text-sm bg-indigo-800 px-3 py-1.5 rounded hover:bg-indigo-900 font-semibold">Logout</button></form>
    </nav>
            ...
            <div class="bg-white p-5 rounded-lg shadow border border-gray-200 grid grid-cols-1 lg:grid-cols-3 gap-6 mb-5">
                ...
                <div class="space-y-2 text-xs lg:col-span-1">
                    ...
                    <div class="pt-2">
                        ...
                        "><?php echo e($t->status === 'completed' ? 'Completed (Pending PDF)' : $t->status); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border text-xs space-y-3 lg:col-span-1">
                    ...
                    <?php else: ?>
                        ...
                        <?php if($t->status === 'in_progress' || $t->status === 'completed'): ?>
                            ...
                            <form action="/web/tasks/<?php echo e($t->id); ?>/update-status" method="POST" class="bg-white p-2 rounded border space-y-1.5">
                                ...
                                <div class="flex gap-1.5">
                                    <select name="status" class="w-full p-1 border rounded bg-gray-50 text-xs">
                                    ...
                                    <button type="submit" class="bg-gray-800 text-white font-bold px-2.5 rounded text-[11px] hover:bg-black">Set</button>
                                </div>
                            </form>
...
</html><?php /**PATH D:\Placement\Abstract flow\AbstractFlow\resources\views/dashboard.blade.php ENDPATH**/ ?>